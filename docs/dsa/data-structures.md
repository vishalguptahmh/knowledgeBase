...
![DSA pattern](../../assets/images/dsapatternsheet.jpg)
...
----
### LinkList
- `!` [ Insert Element at first](single-linked-list.md)
- `!`[ Inserting node at nth position](single-linked-list.md)
- `!`[ Delete Node at nth position](single-linked-list.md)
- `!`[ Reverse a linked list with recursion ](single-linked-list.md)
- `!`[ Reverse a linked list without recursion](single-linked-list.md)
- `!`[ Implement stack using Linklist](single-linked-list.md)
- [Find the 4th node from the end in a singly linked list](single-linked-list.md)
- [Find the middle element of a singly linked list in one pass](single-linked-list.md)
- [Check if a given linked list contains a cycle/loop?find the starting node of the cycle and remove the loop ](single-linked-list.md)
