...
- [OOPS , SOLID principals](../system-design/solid-oops.md)
- [UML diagram concepts](../system-design/uml.md)
- [Design Patterns](../system-design/design-patterns.md) - Creational , Structural , Behavioural
- DataStructure [1](../dsa/data-structures.md) [2](https://blog.algomaster.io/p/how-i-mastered-data-structures-and-algorithms)
...
- ! [IAM, Openid(OIDC), oAuth, OAuth2.0](../product/saas-and-product.md) 
- FIDO
- login flow sso 
...
## Questions asked in past interviews
